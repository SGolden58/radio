...
xml = [
    ...
    f'generator-info-url="https://sgolden58.github.io/radio/songslist.xml" '
    f'source-info-url="https://sgolden58.github.io/radio/songslist.xml?channel_id=988&amp;date={now.strftime("%Y%m%d")}">',
    '<channel id="988">',
