...
# === 2️⃣ Extract songs from table (history) ===
rows = soup.select("table tr")
songs = []

for row in rows[1:34]:  # take first 33 history songs
...
print(f"✅ EPG.xml generated — {len(songs)} history songs, exact times from playlist")
